...
?gganimate::animate() ## uses \dontrun
?plotly::animation() ## Uses if(interactive()) for a 9 sec example
?DALEX::predict_parts_shap() ## uses SHAP on a simple LM.
?profvis::profvis() ## Uses if(interactive())
